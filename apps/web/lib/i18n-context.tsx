...
const translations = {
  es: {
    ...
    "landing.hero.title1": "Tu compromiso ambiental,",
    "landing.hero.title2": "verificable en blockchain.",
    "landing.hero.subtitle": "BeEnergy conecta empresas con cooperativas solares argentinas. Cada kWh generado queda certificado on-chain — verificable por cualquiera, para siempre.",
    "landing.hero.cta": "Acceder a la plataforma",
    "landing.hero.waitlist": "Hablar con el equipo",
    ...
    "landing.quote": "Las empresas que lideran el cambio no solo reducen su huella — la demuestran.",
    ...
    "certificates.detail.title": "Detalle del Certificado",
    "certificates.detail.cooperative": "Cooperativa",
    "certificates.detail.technology": "Tecnología",
    "certificates.detail.generationPeriod": "Período de Generación",
    "certificates.detail.mintTransaction": "Transacción de Emisión",
    "certificates.detail.retiredBy": "Retirado por",
    "certificates.detail.retireTransaction": "Transacción de Retiro",
    "certificates.detail.share": "Compartir",
    "certificates.detail.copied": "¡Enlace copiado!",
    "certificates.detail.notFoundTitle": "Certificado no encontrado",
    "certificates.detail.notFoundDesc": "El certificado que buscas no existe o ha sido eliminado.",
    "certificates.detail.backToList": "Volver a certificados",
    ...
    "registerCoop.country": "País",
    "registerCoop.province": "Provincia *",
    "registerCoop.city": "Ciudad *",
  ...
  en: {
    ...
    "landing.hero.title1": "Your environmental commitment,",
    "landing.hero.title2": "verifiable on blockchain.",
    "landing.hero.subtitle": "BeEnergy connects companies with Argentine solar cooperatives. Every kWh generated is certified on-chain — verifiable by anyone, forever.",
    "landing.hero.cta": "Access the platform",
    "landing.hero.waitlist": "Talk to the team",
    ...
    "landing.quote": "Leading companies don't just reduce their footprint — they prove it.",
    ...
    "certificates.detail.title": "Certificate Detail",
    "certificates.detail.cooperative": "Cooperative",
    "certificates.detail.technology": "Technology",
    "certificates.detail.generationPeriod": "Generation Period",
    "certificates.detail.mintTransaction": "Mint Transaction",
    "certificates.detail.retiredBy": "Retired by",
    "certificates.detail.retireTransaction": "Retire Transaction",
    "certificates.detail.share": "Share",
    "certificates.detail.copied": "Link copied!",
    "certificates.detail.notFoundTitle": "Certificate not found",
    "certificates.detail.notFoundDesc": "The certificate you are looking for does not exist or has been removed.",
    "certificates.detail.backToList": "Back to certificates",
    ...
    "registerCoop.country": "Country",
    "registerCoop.province": "Province *",
    "registerCoop.city": "City *",
