...
const translations = {
  es: {
    ...
    "marketplace.total_energy": "Energía Total Generada",
    "marketplace.sell_offers": "Ofertas de Venta",
    "marketplace.buy_offers": "Ofertas de Compra",
    "marketplace.no_buy_offers": "No hay ofertas de compra disponibles",
    "marketplace.buy_energy": "Comprar Energía",
    "marketplace.sell_energy": "Vender Energía",
    ...
    "sidebar.cooperativas": "Cooperativas",
    ...
    "header.copy_wallet": "Copiar dirección de wallet",
    ...
    // KPI Cards & Charts (dashboard components)
    "kpi.energy_generated": "Energía Generada",
    "kpi.energy_consumed": "Energía Consumida",
    "kpi.available_energy": "Energía Disponible",
    "kpi.monthly_savings": "Ahorro Mensual",
    "kpi.hdrop_balance": "Balance HDROP",
    "kpi.today": "Hoy",
    "kpi.this_month": "Este mes",
    "chart.production_vs_consumption": "Producción vs Consumo de Energía",
    "chart.production": "Producción",
    "chart.consumption": "Consumo",
    "chart.available_energy": "Energía Disponible en el Tiempo",
    "chart.energy_distribution": "Distribución de Energía",
    "chart.consumed_locally": "Consumido localmente",
    "chart.stored": "Almacenado",
    "chart.sold": "Vendido a la comunidad",
    "chart.24h": "24h",
    "chart.7d": "7d",
    "chart.30d": "30d",
    "chart.marketplace_revenue": "Ingresos del Mercado",
    "ranking.title": "Ranking de Eficiencia de la Comunidad",
    "ranking.subtitle": "Usuarios más eficientes de la red",
    "ranking.rank": "Posición",
    "ranking.user": "Usuario",
    "ranking.energy_produced": "Energía Producida",
    "ranking.tokens_earned": "Tokens Ganados",
    "ranking.savings": "ahorro",
    ...
    "transactions.energy_sale": "Venta de Energía",
    "transactions.token_transfer": "Transferencia de Tokens",
    "transactions.energy_purchase": "Compra de Energía",
    "general.view_all": "Ver Todo",
    "general.close": "Cerrar",
    "general.cancel": "Cancelar",
    "efficiency.title": "Puntuación de Eficiencia Energética",
    "efficiency.description": "Porcentaje de energía autoconsumida o compartida eficientemente",
    ...
    "analytics.activity_timeline": "Línea de Tiempo de Actividad",
  ...
  en: {
    ...
    "marketplace.total_energy": "Total Energy Generated",
    "marketplace.sell_offers": "Sell Offers",
    "marketplace.buy_offers": "Buy Offers",
    "marketplace.no_buy_offers": "No buy offers available",
    "marketplace.buy_energy": "Buy Energy",
    "marketplace.sell_energy": "Sell Energy",
    ...
    // Sidebar
    "sidebar.dashboard": "Dashboard",
    "sidebar.cooperativas": "Cooperatives",
    "sidebar.marketplace": "Marketplace",
    ...
    "header.copy_wallet": "Copy wallet address",
    ...
    // KPI Cards & Charts (dashboard components)
    "kpi.energy_generated": "Energy Generated",
    "kpi.energy_consumed": "Energy Consumed",
    "kpi.available_energy": "Available Energy",
    "kpi.monthly_savings": "Monthly Savings",
    "kpi.hdrop_balance": "HDROP Balance",
    "kpi.today": "Today",
    "kpi.this_month": "This month",
    "chart.production_vs_consumption": "Production vs Consumption",
    "chart.production": "Production",
    "chart.consumption": "Consumption",
    "chart.available_energy": "Available Energy Over Time",
    "chart.energy_distribution": "Energy Distribution",
    "chart.consumed_locally": "Consumed locally",
    "chart.stored": "Stored",
    "chart.sold": "Sold to community",
    "chart.24h": "24h",
    "chart.7d": "7d",
    "chart.30d": "30d",
    "chart.marketplace_revenue": "Marketplace Revenue",
    "ranking.title": "Community Efficiency Ranking",
    "ranking.subtitle": "Most efficient users on the network",
    "ranking.rank": "Rank",
    "ranking.user": "User",
    "ranking.energy_produced": "Energy Produced",
    "ranking.tokens_earned": "Tokens Earned",
    "ranking.savings": "savings",
    ...
    "transactions.energy_sale": "Energy Sale",
    "transactions.token_transfer": "Token Transfer",
    "transactions.energy_purchase": "Energy Purchase",
    "general.view_all": "View All",
    "general.close": "Close",
    "general.cancel": "Cancel",
    "efficiency.title": "Energy Efficiency Score",
    "efficiency.description": "Percentage of energy self-consumed or shared efficiently",
    ...
    "analytics.activity_timeline": "Activity Timeline",
    "analytics.from": "From",
    "analytics.to": "To",
  },
}
